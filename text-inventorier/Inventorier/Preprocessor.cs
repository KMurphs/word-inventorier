...
namespace WordInventoryApp
{
    ...
    public class TextPreprocessor
    {
        ...
        /// <param name="sanitizeText">Boolean to optionally pre-process the received text</param>
        /// <returns>An awaitable object that eventually resolves into the string fetched at the input url</returns>
        public async Task<string> FetchCorpus(string _url, Boolean sanitizeText = true)
        {   
            ...
            return sanitizeText ? Sanitize(content) : content;
        }
