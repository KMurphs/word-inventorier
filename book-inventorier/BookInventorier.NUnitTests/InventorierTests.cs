...
namespace BookInventorier.NUnitTests
{
    public class Tests
    {
        ...
        {         
            ...
            int tokensCount;
            double durationMs = bookInventorier.Process(strInput, out freqs, out lengths, out mostFrequentToken, out longestToken, out leastFrequentToken, out shortestToken, out tokensCount);
