...
namespace BookHandler
{
    ...
    public class Handler
    {
        ...
        /// <summary>
        /// Book Processor contains a collection of utilities to pre-process the text before it is used
        /// </summary>
        ...
        /// <summary>
        /// Book Inventorier contains the algorithm that processes the body of text and extract statistics.
        /// </summary>
        ...
        /// </summary>
        /// <param name="bookSrc">The Text to be processed or a http link to a document that must be processed</param>
        ...
        public async Task<BookSummaryAndStructures> Handle(string bookSrc){
            ...
            string bookID = GetHashString(bookSrc); // hash is used as id in the db to cache the result of the processing of the input text
            string bookMeta = "";
